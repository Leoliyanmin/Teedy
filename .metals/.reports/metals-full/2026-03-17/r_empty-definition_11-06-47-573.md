error id: file://<HOME>/Documents/SE%20Lab/Teedy/docs-web/src/main/java/com/sismics/docs/rest/resource/AppResource.java:_empty_/ConfigUtil#getConfigBooleanValue#
file://<HOME>/Documents/SE%20Lab/Teedy/docs-web/src/main/java/com/sismics/docs/rest/resource/AppResource.java
empty definition using pc, found symbol in pc: _empty_/ConfigUtil#getConfigBooleanValue#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 3441
uri: file://<HOME>/Documents/SE%20Lab/Teedy/docs-web/src/main/java/com/sismics/docs/rest/resource/AppResource.java
text:
```scala
...
public class AppResource extends BaseResource {
    ...
    public Response info() {
        ...
        Boolean guestLogin = ConfigUtil.getConfigBoole@@anValue(ConfigType.GUEST_LOGIN);
