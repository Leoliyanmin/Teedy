error id: file://<HOME>/Documents/SE%20Lab/Teedy/docs-web-common/src/main/java/com/sismics/util/filter/SecurityFilter.java:_empty_/HttpServletRequest#
file://<HOME>/Documents/SE%20Lab/Teedy/docs-web-common/src/main/java/com/sismics/util/filter/SecurityFilter.java
empty definition using pc, found symbol in pc: _empty_/HttpServletRequest#
...
public abstract class SecurityFilter implements Filter {
     ...
     * @param request HTTP request
     */
    private void injectAnonymousUser(HttpServle@@tRequest request) {
