error id: file://<HOME>/Documents/SE%20Lab/Teedy/docs-web-common/src/main/java/com/sismics/util/filter/SecurityFilter.java:_empty_/HttpServletRequest#setAttribute#
file://<HOME>/Documents/SE%20Lab/Teedy/docs-web-common/src/main/java/com/sismics/util/filter/SecurityFilter.java
empty definition using pc, found symbol in pc: _empty_/HttpServletRequest#setAttribute#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 4032
uri: file://<HOME>/Documents/SE%20Lab/Teedy/docs-web-common/src/main/java/com/sismics/util/filter/SecurityFilter.java
text:
```scala
...
public abstract class SecurityFilter implements Filter {
    ...
    private void injectAnonymousUser(HttpServletRequest request) {
        ...
        request.setAttri@@bute(PRINCIPAL_ATTRIBUTE, anonymousPrincipal);
    }
